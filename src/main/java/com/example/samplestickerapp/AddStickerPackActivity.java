...
public abstract class AddStickerPackActivity extends BaseActivity {
    ...
    private void launchIntentToAddPackToSpecificPackage(String identifier, String stickerPackName, String whatsappPackageName) {
        ...
        try {
            ...
            String packId = intent.getStringExtra(StickerPackDetailsActivity.EXTRA_STICKER_PACK_ID);
            String packAuthority = intent.getStringExtra(StickerPackDetailsActivity.EXTRA_STICKER_PACK_AUTHORITY);
            String packName = intent.getStringExtra(StickerPackDetailsActivity.EXTRA_STICKER_PACK_NAME);
